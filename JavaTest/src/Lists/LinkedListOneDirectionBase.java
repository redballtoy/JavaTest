 ...
 *     - более эффективная работа с операциями вставки и удаления в середине списка
 *     - менее эффективная работа с операциями произвольного доступа
 *     - имеет методы позволяющие его использовать как стек, очередь, дек(двустороннюю очередь)
 *
 */
